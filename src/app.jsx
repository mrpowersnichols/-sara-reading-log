...
import { BookOpen, Plus, Star, X, Library, ListChecks, Users, ChevronRight, BookMarked, RotateCcw, Search, Flag, Barcode, Heart, Pencil, Trash2, Sparkles, RefreshCw, AlertTriangle, TrendingUp, Award, MessageSquare } from "lucide-react";
                ...
                {reading.map((b) => {
                  ...
                  return (
                    <div className="rl-card" key={b.id}>
                      ...
                      {(() => {
                        const latest = sortStatusDesc(statusEntries.filter((s) => s.logEntryId === b.id))[0];
...
function StudentDetailModal({ student, entries, statusEntries, onClose }) {
